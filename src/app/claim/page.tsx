    ...
    <AppShell
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            { href: "/", label: "Overview" },
            { label: "Claim your place" },
          ]}
        />
      }
      title="Claim your place on the class list"
      description="Class lists carry a student number and a name, but no email address — so tell us your number and your teacher will confirm it is you."
      roomy
    >
        ...
        {status.kind === "confirmed" ? (
          ...
          <>
            <Alert variant="info" title="What happens to what you type">
              ...
              characters are shown to staff in lists. Signing in on its own
              gives you no access to anyone&apos;s work.
            </Alert>
            <RosterClaim
              action={claim}
