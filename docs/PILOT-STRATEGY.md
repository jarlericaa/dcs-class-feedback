...
out-of-scope item (see [mvp-scope.md](mvp-scope.md) §4).
...
**Companion:** [INTENT-CONTEXT.md](INTENT-CONTEXT.md) owns user conditions,
...
4. **Browser e2e on the two highest-consequence journeys only** — submit near
   ...
   credit or costs anonymity ([INTENT-CONTEXT.md](INTENT-CONTEXT.md) §3.1).
...
6. **Deployment automation and the pilot checklist** in
   [DEPLOYMENT.md](DEPLOYMENT.md), including the restore test.
...
- **Everything in [mvp-scope.md](mvp-scope.md) §2 and §3.** Unchanged. No
  promotion proposed.

**Out of scope for Phase 1 but named so it is not lost:** publish-friction
adequacy ([INTENT-CONTEXT.md](INTENT-CONTEXT.md) §8.6). An acknowledgement
...
[INTENT-CONTEXT.md](INTENT-CONTEXT.md) · [../PRODUCT.md](../PRODUCT.md) ·
[PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md) · [CURRENT_STATE.md](CURRENT_STATE.md) ·
[open-decisions.md](open-decisions.md) · [mvp-scope.md](mvp-scope.md) ·
[DESIGN-RESEARCH.md](DESIGN-RESEARCH.md) · [DEPLOYMENT.md](DEPLOYMENT.md) ·
