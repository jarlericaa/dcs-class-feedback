...
> Label key as in [requirements.md](requirements.md).

## 1. Position **[Confirmed]**

AI is **post-MVP and low priority**. Do not build AI features, AI infrastructure, dedicated vector databases, standalone AI services, or model fine-tuning as part of MVP ([scope.md](scope.md)).
...
- Keep clean, structured content: category (Content/Logistics/Misc) and lesson/topic tags on questions ([domain/form-workflow.md](../domain/form-workflow.md), [domain/domain-model.md](../domain/domain-model.md)).
- Reserve course-level ownership + topic tagging so a future `CourseMaterial` entity attaches cleanly ([domain/domain-model.md](../domain/domain-model.md)) — **without** building material management in MVP.
...
[scope.md](scope.md) · [domain/domain-model.md](../domain/domain-model.md) · [domain/public-qa.md](../domain/public-qa.md) · [engineering/architecture-history.md](../engineering/architecture-history.md) · [requirements.md](requirements.md)
