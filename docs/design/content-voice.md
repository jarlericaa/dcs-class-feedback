...
**Does not own:** navigation structure ([information-architecture.md](information-architecture.md)), flow
...
Rejected in [design/journeys/student-first-run.md](journeys/student-first-run.md) F6 on
...
> Students in this section will see it. You cannot take it back yet — unpublishing is approved (**D6**) but not built ([engineering/current-state.md](../engineering/current-state.md) `E2`).
...
The cases [design/journeys/student-submit.md](journeys/student-submit.md) A3 shows are
...
[information-architecture.md](information-architecture.md) set the constraints and left the strings here.
...
- **Read aloud in sequence.** Every visibility string must make sense to a screen
  ...
  ([context.md](context.md) §4.2 — a privacy warning that is missed
...
[context.md](context.md) §4.1, and the third implies the submission
...
2. **Does the no-contractions register read as cold to students, or as
   ...
   student sessions ([product/pilot-strategy.md](../product/pilot-strategy.md) §5 activity #2)
...
- `/specify` — the register rule in §3 is an implementation contract at every catch
  ...
  ([design/journeys/teacher-setup.md](journeys/teacher-setup.md) F6).
...
[../PRODUCT.md](../../PRODUCT.md) · [information-architecture.md](information-architecture.md) ·
...
[public-qa.md](../domain/public-qa.md) · [../../DESIGN.md](../../DESIGN.md)
