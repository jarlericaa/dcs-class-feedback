...
> [README.md](../../README.md) outrank this file on every product fact. Where this file
...
Role definitions are owned by [domain/roles-and-permissions.md](../domain/roles-and-permissions.md).
...
- **Structural asymmetry** **[Confirmed], design implication [Recommended]**:
  submission is credit-bearing ([domain/participation.md](../domain/participation.md)),
...
- **The decision they are actually making:** *is this safe to publish?* Every
  ...
  ([engineering/current-state.md](../engineering/current-state.md) E2). And even once it ships,
...
- **[Confirmed]**: holds **every** teacher capability on whatever they are
  assigned to — `product/specification.md` §4.1, "all instructors assigned to a course
...
No primary research exists. [research.md](research.md) is competitor and
pattern study, not user study. There are no interviews, no
...
- **Maturity** **[Implemented]**: pilot-usable for the core loops — setup,
  ...
  [engineering/current-state.md](../engineering/current-state.md) lists surfaces that are `missing`,
...
[DESIGN.md](../../DESIGN.md) is the design authority: the departmental-noticeboard
visual system, its tokens, type registers, states and anti-patterns. Where a
token table anywhere else disagrees with it, DESIGN.md wins, and
`src/app/globals.css` is the implementation of it.
...
state never leaks into a student view. Sources: [engineering/security.md](../engineering/security.md),
[domain/public-qa.md](../domain/public-qa.md),
[domain/legacy-question-import.md](../domain/legacy-question-import.md),
[product/ai-future-plan.md](../product/ai-future-plan.md), [product/scope.md](../product/scope.md).
...
- **Data minimisation is not "the roster carries no email".** **[Confirmed —
  ...
  avoided ([domain/student-identity.md](../domain/student-identity.md)).
- **Social mechanics are not uniformly out of scope.** **Reactions and moderated
  comments (`P2`) are approved full scope** — promoted by `product/specification.md` §8
  and recorded in the scope-expansion table in [product/scope.md](../product/scope.md) —
  though **[Implemented]** they are not: [engineering/current-state.md](../engineering/current-state.md)
...
end-to-end suite exists ([engineering/testing.md](../engineering/testing.md), [engineering/current-state.md](../engineering/current-state.md)).
...
[product/overview.md](../product/overview.md) are explicitly proposed rather than
...
8. Entries in [decisions/open-decisions.md](../decisions/open-decisions.md) that change a user-visible
...
[product/requirements.md](../product/requirements.md) · [product/scope.md](../product/scope.md) ·
[domain/roles-and-permissions.md](../domain/roles-and-permissions.md) ·
[domain/public-qa.md](../domain/public-qa.md) ·
[domain/participation.md](../domain/participation.md) ·
[domain/form-workflow.md](../domain/form-workflow.md) · [engineering/security.md](../engineering/security.md) ·
[../../DESIGN.md](../../DESIGN.md) · [current-state.md](../engineering/current-state.md) ·
