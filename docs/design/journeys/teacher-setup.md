...
> [domain/forms-and-audiences.md](../../domain/forms-and-audiences.md) §7
...
proposed changes. No scope change: nothing from [product/scope.md](../../product/scope.md)
...
**Companions:** [student-first-run.md](student-first-run.md) — this
journey's ordering failure is what causes that one's P0 ·
[product/pilot-strategy.md](../../product/pilot-strategy.md) §5 activity #3 · [design/context.md](../context.md).
...
([student-first-run.md](student-first-run.md) F1).

This journey is also the one [product/pilot-strategy.md](../../product/pilot-strategy.md) §4 Q5 names
...
**No research exists** ([product/pilot-strategy.md](../../product/pilot-strategy.md) §2), and unlike the
...
- **The roster importer's judgement about each row.** What this document
  ...
  **Superseded 2026-09-07 (GitHub issue #12):** the *screen* described here — an
  ...
  dropped. See [domain/student-identity.md](../../domain/student-identity.md) §5.
...
> [IA structure banner](../information-architecture.md) for the two-layer model. The finding
...
- plus the student blocked states ([student-first-run.md](student-first-run.md) F2)
...
|---|---|---|
| Student weekly form | [student-submit.md](student-submit.md) F2 | typed answers on transport failure |
| Teacher publish composer | [teacher-publish.md](teacher-publish.md) F5 | the rewording — the R2 mitigation itself |
...
Section nav — SUPERSEDED, see design/information-architecture.md F1                              [F3]
   ...
   design/information-architecture.md is authoritative on nav structure; this file stays
...
> ([domain/student-identity.md](../../domain/student-identity.md)). The finding it serves is
...
| Concern | Spec |
|---|---|
| `sectionReadiness` | Derived per section: roster count, template existence, active schedule. All three are existing queries. Compute alongside `staffSectionAttention` on the dashboard, and on the course list. (A fourth input, a pending-match count, was proposed here before decision **D23** removed account matching; there is no such query and no such state — see §5 and [domain/student-identity.md](../../domain/student-identity.md).) |
...
| Accessibility | Readiness badges convey state in text, not colour alone — already the house rule ([engineering/current-state.md](../../engineering/current-state.md) "UI maturity"). The risk notice is a `role="status"` region, not a bare paragraph. |
...
([product/pilot-strategy.md](../../product/pilot-strategy.md) §6 item 5).
...
1. **The unbooked hour.** [product/pilot-strategy.md](../../product/pilot-strategy.md) §5 activity #3 —
...
- `/organize` — **answered** in [design/information-architecture.md](../information-architecture.md) F1:
...
[student-first-run.md](student-first-run.md) ·
[student-submit.md](student-submit.md) ·
[teacher-publish.md](teacher-publish.md) ·
[product/pilot-strategy.md](../../product/pilot-strategy.md) · [design/context.md](../context.md) ·
[domain/student-identity.md](../../domain/student-identity.md) ·
