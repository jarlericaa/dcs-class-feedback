...
**Companions:** [student-submit.md](student-submit.md) (strictly
downstream of this) · [domain/student-identity.md](../../domain/student-identity.md) (owns the rules)
· [design/context.md](../context.md).
...
their own address ([domain/student-identity.md §5](../../domain/student-identity.md#5-what-a-student-sees-confirmed)).
...
stored binding made at login ([domain/student-identity.md §1](../../domain/student-identity.md#1-authentication-confirmed)).
...
([domain/student-identity.md §7.3](../../domain/student-identity.md#73-email-rules-blocking-not-advisory)).

The teacher-side journey is [teacher-setup.md](teacher-setup.md).
