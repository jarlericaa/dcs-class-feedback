...
> until the deadline → lock** (`AGENTS.md` §4, `product/specification.md` §4.3,
> `engineering/current-state.md` B4), and the running app says so
...
surface, nothing from [product/scope.md](../../product/scope.md) §2/§3 is promoted.
...
**Companions:** [design/context.md](../context.md) (user conditions, ethical
stance) · [product/pilot-strategy.md](../../product/pilot-strategy.md) (what the pilot must learn).
...
- **Credit.** Submitting is participation ([domain/participation.md](../../domain/participation.md)).
...
draw it from.** Zero primary research exists ([product/pilot-strategy.md](../../product/pilot-strategy.md) §2).
...
problem is upstream of this flow. [product/pilot-strategy.md](../../product/pilot-strategy.md) §5
activity #2 (five sessions) resolves it in about a day.

**Assumed conditions**, all **[Assumption]** per
[design/context.md](../context.md) §1.1: phone, during or right after class,
...
It also drops a **[Recommended]** instruction already on record in the design
direction: *"Keep the student-originated question area visually separate and
explain that the question can be reworded before publication."* Separation
shipped; the explanation did not.
...
per navigation ([engineering/current-state.md](../../engineering/current-state.md) §"UI maturity") with no
...
- Anything using participation credit as leverage — *"don't lose your
  ...
  banned by [design/context.md](../context.md) §4.1(2). The stake is real,
...
- Cheerfulness at the free-text field. It may carry a report of distress or a
  complaint about the person who will read it ([design/context.md](../context.md) §4.4).
...
([design/context.md](../context.md) §4.2). And the review step must not trap
focus.
...
Tie to [design/context.md](../context.md) §6. All **[Recommended]**; the
...
[design/context.md](../context.md) §6.
...
[../PRODUCT.md](../../../PRODUCT.md) · [domain/form-workflow.md](../../domain/form-workflow.md) ·
[domain/public-qa.md](../../domain/public-qa.md) ·
