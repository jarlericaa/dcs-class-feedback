...
>
> It does **not** restate state machines ([domain/domain-model.md](domain-model.md#3-state-models)),
> authorization ([domain/roles-and-permissions.md](roles-and-permissions.md)), publication
> rules ([public-qa.md](public-qa.md)), or
> participation derivation ([participation.md](participation.md)) — it
> links to them.
>
...
- **Deadlines.** A form instance has **one** open/deadline window, in one
  ...
  ([D7](../decisions/open-decisions.md)), so the window is unambiguous in the pilot.
...
Unchanged policy ([D4](../decisions/open-decisions.md)), now stated in code and tests:
...
types in [form-workflow.md](form-workflow.md#5-teacher-created-questions--dynamic-form-schema)
...
|---|---|---|
| A — document the model | done | this document; [domain/domain-model.md](domain-model.md), [form-workflow.md](form-workflow.md), [design/information-architecture.md](../design/information-architecture.md), [decisions/open-decisions.md](../decisions/open-decisions.md), [AGENTS.md](../../AGENTS.md), and the two JOURNEY files reconciled where they were actually affected |
...
Resolved by this work, in [decisions/open-decisions.md](../decisions/open-decisions.md):
...
Left open, also in [decisions/open-decisions.md](../decisions/open-decisions.md):
...
[domain/domain-model.md](domain-model.md) · [form-workflow.md](form-workflow.md) ·
[domain/roles-and-permissions.md](roles-and-permissions.md) ·
[participation.md](participation.md) ·
[public-qa.md](public-qa.md) ·
[design/information-architecture.md](../design/information-architecture.md) · [decisions/open-decisions.md](../decisions/open-decisions.md) ·
