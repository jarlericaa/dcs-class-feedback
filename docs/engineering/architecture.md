...
trade-off discussion remains in [engineering/architecture-history.md](architecture-history.md).
...
The current route inventory is maintained in [current-state.md](current-state.md).
...
| `/teach/courses/[id]/publications` | The course's one publication queue |
| `/teach/courses/[id]/backlog` | The course's one question backlog |
...
5. The TypeScript stack is the **settled** baseline — D1 closed 2026-08-03 and
   ...
   [engineering/architecture-history.md](architecture-history.md).
...
[current-state.md](current-state.md) `F1`.
