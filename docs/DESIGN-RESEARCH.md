...
For screenshot-bearing links, direct image references, and the screen-by-screen
translation checklist, use
[ED_DISCUSSION_REFERENCE_PACK.md](ED_DISCUSSION_REFERENCE_PACK.md).
